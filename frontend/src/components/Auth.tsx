  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-black p-4 transition-colors">
      ...
      <div className="w-full max-w-md bg-white dark:bg-black p-8 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 transition-colors">
        ...
        <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-white mb-6 transition-colors">{isSignUp ? 'Create Account' : 'Welcome Back'}</h2>
        ...
        <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400 transition-colors">
          ...
          className="text-indigo-600 hover:text-indigo-800 font-medium hover:underline focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        >
